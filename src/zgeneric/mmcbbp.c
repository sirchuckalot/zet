...
#define IO_SDCARD   0x0100      /* IO port of the sd card controller */
...
static void     outb(USHORT port, UCHAR  val);
static void     outw(USHORT port, USHORT  val);
...
)
{
	...
	// outw(IO_SDCARD, {0x00, cmd});   /* Modified to both select card and sent command */
	outw(IO_SDCARD, 0x0000);   /* Modified to both select card and sent command */
